...
function HeroSection() {
  return (
    <header className="flex items-center justify-center h-svh px-5 lg:px-20 bg-gray-800 bg-[url('./assets/hero-bg2.jpg')] bg-blend-overlay bg-center bg-cover bg-no-repeat bg-fixed">
      <div
        data-aos='fade-in'
